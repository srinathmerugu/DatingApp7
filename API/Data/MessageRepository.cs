    ...
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            query = messageParams.Container switch
            {
                ...
                _ => query.Where(u => u.RecipientUserName == messageParams.UserName && !u.RecipientDeleted && u.DateRead == null) //unread msgs are sent by default
            };
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUserName, string recipientUserName)
        {
            ...
            .Where(
                m => m.RecipientUserName == currentUserName && !m.RecipientDeleted && m.SenderUserName == recipientUserName ||

    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
            ...
            */
            ...
            CreateMap<Message, MessageDto>().ForMember(dest => dest.SenderPhotoUrl, options => options
            .MapFrom(sender => sender.Sender.Photos.FirstOrDefault(p => p.IsMain).Url))
            .ForMember(dest => dest.RecipientPhotoUrl, options => options
            .MapFrom(recipient => recipient.Recipient.Photos.FirstOrDefault(p => p.IsMain).Url));
        }
    }
}